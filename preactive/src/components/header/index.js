			...
			<div>
				<TopAppBar className="topappbar">
					<TopAppBar.Row>
						<TopAppBar.Section align-start>
							...
							<TopAppBar.Title>Preactive</TopAppBar.Title>
						</TopAppBar.Section>
						<TopAppBar.Section
							align-end
							shrink-to-fit
				...
				<Drawer modal ref={this.drawerRef}>
					<Drawer.DrawerContent>
						...
						<Drawer.DrawerItem
							selected={props.selectedRoute === '/preact'}
							onClick={this.goToPreact}
						>
							<List.ItemGraphic>link</List.ItemGraphic>
							Preact
						</Drawer.DrawerItem>
					</Drawer.DrawerContent>
				</Drawer>
